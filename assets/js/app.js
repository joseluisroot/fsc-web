...
// Start non-blocking performance optimizations as early as possible.
import('./performance.js').catch(error=>console.error('FSC performance enhancements:',error));
